...
class MovieGridAdapter(private val item: ArrayList<MovieModel>, private val movieUserActionListener: MovieUserActionListener) : RecyclerView.Adapter<MovieGridAdapter.Holder>()/*, StaffUserActionListener*/ {

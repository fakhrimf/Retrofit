...
class ShowGridAdapter(private val item: ArrayList<ShowModel>, private val showUserActionListener: ShowUserActionListener) : RecyclerView.Adapter<ShowGridAdapter.Holder>()/*, StaffUserActionListener*/ {

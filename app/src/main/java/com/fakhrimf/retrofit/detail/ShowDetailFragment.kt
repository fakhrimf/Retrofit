...
class ShowDetailFragment : Fragment(), ShowDetailUserActionListener {
    ...
    override fun onCreateView(
        ...
        showDetailVM = ViewModelProvider.AndroidViewModelFactory(activity!!.application).create(ShowDetailVM::class.java)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val modelCheck = showDetailVM.checkFavorite(arguments?.getParcelable<ShowModel>(VALUE_KEY) as ShowModel)
        if(modelCheck){
